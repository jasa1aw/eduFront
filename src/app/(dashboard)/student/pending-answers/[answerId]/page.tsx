			...
			<div className="max-w-5xl mx-auto">
							...
							<div>
								...
								<div className="flex items-center gap-4 text-sm text-gray-600">
									<div className="flex items-center gap-2">
										...
										<span>Сұрақ салмағы: {answerDetail.questionWeight} ұпай</span>
									</div>
									<div className="flex items-center gap-2">
				...
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
					...
					<div className="lg:col-span-2 space-y-6">
						{/* Student Answer */}
						<div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
							<h3 className="text-lg font-semibold text-gray-900 mb-4">Студент жауабы</h3>
						...
						<div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
							...
							{answerDetail.status === 'PENDING' ? (
								<div className="space-y-4">
									<p className="text-gray-600 mb-4">
										Студенттің осы сұрақтағы жауабының дұрыстығын бағалаңыз:
									</p>
							...
							<div className="mt-6 pt-6 border-t border-gray-200">
								...
								>
									...
									{recalculateScoreMutation.isPending ? 'Қайта есептеуде...' : 'Ұпайларды қайта есептеу'}
								</Button>
							</div>
						</div>
					</div>
					...
					<div className="space-y-6">
						...
						{/* Attempt Info */}
						<div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
							<h3 className="text-lg font-semibold text-gray-900 mb-4">Әрекет туралы ақпарат</h3>
							<div className="space-y-4">
								<div className="flex items-center justify-between">
									<span className="text-gray-600">Ағымдағы ұпай:</span>
									<div className="flex items-center gap-2">
